...
\linespread{1.2} % linespacing = 120%
\parskip=1.2em % paragraph spacing is 120% of the height of M
\parindent=3cm % the paragraph indent is 3cm
...
Tomatis, Ortin, and Dufourd \marginpar{Please insert video here}
